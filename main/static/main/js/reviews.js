let buttonWriteReview = document.querySelector("main .reviews .reviews__write_review .button_write_review");
let textareaReview = buttonWriteReview.closest(".reviews__write_review").querySelector("textarea");
let userReview = textareaReview.dataset.userreview;
...
if(textareaReview.dataset.userreview != ""){
    textareaReview.value = textareaReview.dataset.userreview;
